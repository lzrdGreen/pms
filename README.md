...
************************************************************************************************************************************************************************************************    
This project uses SQLite by default. To set up the database on your local machine, clone the repository   

pip install -r requirements.txt   

Run migrations; for admin access create a superuser: python manage.py createsuperuser   

Finally, run the Django development server and access the app:  
